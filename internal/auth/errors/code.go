...
var (
	...
	AUTH_REG_006 = NewAppError(http.StatusUnprocessableEntity, "AUTH_REG_006", "INVALID_EMAIL")
	AUTH_REG_007 = NewAppError(http.StatusUnprocessableEntity, "AUTH_REG_007", "INVALID_PHONE")
